...
def addfriend():
    ...
    friend_list["text"] = "Your Cart :" + str(list1)
...
def random_number():
    ...
    lucky_friend["text"] = "This is whats in the cart-" + str(generated_random_number)
    
btn = Button(root, text="What you want to add to cart", command = addfriend)
btn.place(relx=0.5 ,rely=0.3, anchor = CENTER)

friend_list.place(relx=0.5, rely = 0.4, anchor = CENTER)

btn1 = Button(root, text="The cart.  ", command = random_number)
